...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/nearby.js":[function(require,module,exports) {
        ...
        this.mousemoveFn = function (ev) {
          return requestAnimationFrame(function () {
            ...
            if (_this.options.onProgress) {
              _this.options.onProgress(distancePoints(mousepos.x, mousepos.y, closestPoint.x, closestPoint.y), getMousePos(ev));
            }
          });
        };
...
},{}],"node_modules/charming/index.js":[function(require,module,exports) {
...
var element = document.querySelector('.c-main-title h1');

if (!element.classList.contains('charmed')) {
  (0, _charming.default)(element);
  element.classList.add('charmed');

  var chars = _toConsumableArray(document.querySelectorAll('.c-main-title__title span[class^=char]'));

  chars.sort(function () {
    return 5 - Math.random();
  });

  _gsap.TweenMax.staggerFrom(chars, 1, {
    rotationZ: '35deg',
    x: '-=25px',
    y: '-=55px',
    opacity: 0,
...
},{"charming":"node_modules/charming/index.js","gsap":"node_modules/gsap/index.js"}],"assets/js/color-filter.js":[function(require,module,exports) {
var $background = document.querySelector('.main-background');
var $list = document.querySelector('.c-date__list');
$list.addEventListener('mouseover', function (e) {
  if (e.target.tagName === "A") {
    var $scene = document.querySelector('canvas'); // console.log($scene);
    // console.log($scene.style);

    var hue = e.target.parentNode.dataset.hue || 0;
    $background.style.filter = "hue-rotate(".concat(hue, "deg)");

    if (window.matchMedia("(min-width: 768px)").matches) {
      $scene.style.filter = "hue-rotate(".concat(hue, "deg) saturate(200%)");
    }
...
},{"process":"node_modules/process/browser.js"}],"assets/js/custom-transition.js":[function(require,module,exports) {
"use strict";
...
function (_Highway$Transition) {
  ...
  function CustomTransition() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CustomTransition).apply(this, arguments));
  }
  ...
  _createClass(CustomTransition, [{
    ...
    value: function out(_ref) {
      ...
      var transition = document.querySelector('.o-transition');
      var transitionSpans = document.querySelectorAll('.o-transition span');
      transition.style.display = "flex";

      _gsap.TweenMax.staggerFromTo(transitionSpans, 0.5, {
        x: "-100%"
      }, {
        x: "0%"
      }, 0.2, done);
    ...
    value: function _in(_ref2) {
      ...
      _gsap.TweenMax.staggerFromTo(chars, 1, {
        rotationZ: '35deg',
        x: '-=25px',
        y: '-=55px',
        opacity: 0,
...
var _default = CustomTransition;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","charming":"node_modules/charming/index.js","gsap":"node_modules/gsap/index.js"}],"assets/js/custom-renderer.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","charming":"node_modules/charming/index.js","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/AOS/dist/aos.js":[function(require,module,exports) {
var define;
...
var _customTransition = _interopRequireDefault(require("./custom-transition"));
...
if (window.matchMedia("(min-width: 768px)").matches) {
  require("_bundle_loader")(require.resolve('./scene')).then();

  require("_bundle_loader")(require.resolve('./magnet')).then();
}
...
var H = new _highway.default.Core({
  ...
  transitions: {
    default: _customTransition.default
  }
});
},{"./nearby":"assets/js/nearby.js","./charming":"assets/js/charming.js","./color-filter":"assets/js/color-filter.js","@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","./custom-transition":"assets/js/custom-transition.js","./custom-renderer":"assets/js/custom-renderer.js","gsap":"node_modules/gsap/index.js","_bundle_loader":"node_modules/parcel-bundler/src/builtins/bundle-loader.js","./scene":[["scene.3e8b568c.js","assets/js/scene.js"],"scene.3e8b568c.js.map",["house.a4b6469d.glb","assets/models/house.glb"],["matcap-porcelain-white.5eb758fb.jpg","assets/models/matcap-porcelain-white.jpg"],"assets/js/scene.js"],"./magnet":[["magnet.888e4373.js","assets/js/magnet.js"],"magnet.888e4373.js.map","assets/js/magnet.js"],"AOS":"node_modules/AOS/dist/aos.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0,"assets/js/main.js"], null)
